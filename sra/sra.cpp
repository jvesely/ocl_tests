...
int main(int argc, const char*argv[])
{
	...
	int64_t data[DATA_SIZE];       // original data set given to device
	int64_t results[DATA_SIZE];    // results returned from device
	int64_t results2[DATA_SIZE];   // results returned from device
